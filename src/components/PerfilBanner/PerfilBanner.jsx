        ...
        <div className={styles.perfil}>
            ...
            <div className={styles.perfil__sobre}>
                ...
                <div>
                    ...
                    <p className={styles.perfil__texto}>Desenvolvedor Full Stack / Mobile - HTML | CSS | Javascript | React JS | React Native | Node JS | Express | MVC | MySQL | MongoDB | Sequelize | Git | Java</p>
                </div>
            </div>
        </div>
    )
